...
$univer = "(SELECT
              ...
              FROM institute
              INNER JOIN education_info ON education_info.ins_id = institute.ins_id
              INNER JOIN student_info ON student_info.s_id =education_info.s_id
              INNER JOIN country_list ON country_list.country_id = institute.country_id
              ...
              INNER JOIN country_list ON country_list.country_id = institute.country_id
              WHERE country_name = 'Thailand')";
      $result_foreign_u = mysqli_query($link,$univer) or die(mysqli_error());
