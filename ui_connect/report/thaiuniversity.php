...
$sql =' SELECT c.s_fname ,c.s_lname ,a.ins_name,COUNT(*) AS num
        FROM institute a
        INNER JOIN education_info b ON b.ins_id = a.ins_id
        LEFT JOIN student_info c ON b.s_id = c.s_id
        LEFT JOIN application d  ON c.s_id = d.s_id
        WHERE c.origin_id = 2
        GROUP BY ins_name';
           ...
           <div class="container">
             ...
             <div class="navbar-collapse collapse" style="font-size:20px"><b>
               <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="thaiuniversity.php" class="animsition-link">UNIVERSITY</a></li>
...
<!--Bar Chart--><canvas id="horizonbarChart" width="1580" height="1500"></canvas>
